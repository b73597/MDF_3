...
//        mPlayer.setLooping(true);
    ...
    public void createNotification(String sname) {
        ...
        if(index_mp3 == 0) {
            ...
            NotificationCompat.Builder mBuilder =
                    new NotificationCompat.Builder(this)
                            ...
                            .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.image0));
            BigTextStyle bigStyle = new BigTextStyle();
            bigStyle.setBigContentTitle("Playing...");
            bigStyle.setSummaryText(sname);
            bigStyle.bigText("Mother is a song written by R. Waters in the album The Wall ");
        ...
        if(index_mp3 == 1){
            ...
            bigStyle.setBigContentTitle("Playing...");
            bigStyle.setSummaryText(sname);
            bigStyle.bigText("Song written by Michiru Yamane for the video game Castlevania");
            mBuilder.setAutoCancel(true);
            mBuilder.setStyle(bigStyle);
        ...
        if(index_mp3 == 2){
            ...
            bigStyle.setBigContentTitle("Playing...");
            bigStyle.setSummaryText(sname);
            bigStyle.bigText("Young Lust written by Roger Waters for the album The Wall");
            mBuilder.setAutoCancel(true);
            mBuilder.setStyle(bigStyle);
        ...
        if (index_mp3 == 3){
            NotificationCompat.Builder mBuilder =
                    new NotificationCompat.Builder(this)
                            .setSmallIcon(R.drawable.ic_launcher)
                            .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.image3));
            BigTextStyle bigStyle = new BigTextStyle();
            bigStyle.setBigContentTitle("Playing...");
            bigStyle.setSummaryText(sname);
            bigStyle.bigText("Barriers written by the british band Anathema 2002");
            mBuilder.setAutoCancel(true);
            mBuilder.setStyle(bigStyle);
